...
public class NumberToLetterConverter {
    ...
    public static String convertNumberToLetter(String number) throws NumberFormatException {
        ...
        if (splitNumber.length != 1) {
            centavos = Integer.parseInt(String.valueOf(getDigitAt(splitNumber[1], 1)) + String.valueOf(getDigitAt(splitNumber[1], 0)));
            if (splitNumber[1].length() == 1) {
                converted += centavos + "0" + "/100";
                return converted;
            }
        }

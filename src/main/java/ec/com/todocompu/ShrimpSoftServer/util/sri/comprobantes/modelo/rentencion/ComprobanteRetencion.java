...
public class ComprobanteRetencion {
	...
	@XmlType(name = "", propOrder = { "fechaEmision", "dirEstablecimiento", "contribuyenteEspecial",
			"obligadoContabilidad", "tipoIdentificacionSujetoRetenido", "razonSocialSujetoRetenido",
	...
	public static class Impuestos {
		...
		@XmlElement(required = true)
		protected List<ImpuestoRetencion> impuesto;

		public List<ImpuestoRetencion> getImpuesto() {

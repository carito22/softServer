package ec.com.todocompu.ShrimpSoftServer.util.sri.comprobantes.modelo.notadecredito;
...
public class NotaCredito {
	...
	@XmlType(name = "", propOrder = { "fechaEmision", "dirEstablecimiento", "tipoIdentificacionComprador",
			...
			"codDocModificado", "numDocModificado", "fechaEmisionDocSustento", "totalSinImpuestos", "valorModificacion",
	...
	public static class Detalles {
		...
		public static class Detalle {
			...
			public static class Impuestos {
				protected List<ImpuestoNotaCredito> impuesto;

				public List<ImpuestoNotaCredito> getImpuesto() {

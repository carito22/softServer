 ...
 */
public class ReporteResumenPesca {
	...
	public ReporteResumenPesca() {
	}

	public ReporteResumenPesca(String rcSector, String rcPiscina, String rcCorrida, BigDecimal rcHectareaje,
			String rcFechaSiembra, String rcFechaPesca, BigDecimal rcDiasCultivo, BigDecimal rcDiasInactivos,
			BigDecimal rcDensidad, String rcLaboratorio, String rcNauplio, BigDecimal rcBiomasaProy,
			BigDecimal rcBiomasaReal, BigDecimal rcConversionAlim, BigDecimal rcGramos, String rcSobrevivencia,
			BigDecimal rcCosto, BigDecimal rcDirecto, BigDecimal rcIndirecto, BigDecimal rcSubtotal1,
			BigDecimal rcAdministrativo, BigDecimal rcFinanciero, BigDecimal rcGND, BigDecimal rcSubtotal2,
			BigDecimal rcTotal) {

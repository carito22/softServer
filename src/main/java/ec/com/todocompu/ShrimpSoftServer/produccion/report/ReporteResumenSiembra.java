...
public class ReporteResumenSiembra {
	...
	public ReporteResumenSiembra(String rcSector, String pisNumero, String rcCorrida, BigDecimal rcHectareaje,
			String rcFechaSiembra, BigDecimal rcDiasCultivo, BigDecimal rcDiasInactivos, BigDecimal rcDensidad,
			String rcLaboratorio, String rcNauplio, BigDecimal rcBiomasaProy, BigDecimal rcBiomasaReal,
			BigDecimal rcConversionAlim, BigDecimal rcGramos, String rcSobrevivencia, BigDecimal rcCosto,
			BigDecimal rcDirecto, BigDecimal rcIndirecto, BigDecimal rcSubtotal1, BigDecimal rcAdministrativo,
			BigDecimal rcFinanciero, BigDecimal rcGND, BigDecimal rcSubtotal2, BigDecimal rcTotal) {

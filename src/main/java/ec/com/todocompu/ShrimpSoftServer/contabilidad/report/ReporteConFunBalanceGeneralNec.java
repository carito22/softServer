...
public class ReporteConFunBalanceGeneralNec {
	...
	public ReporteConFunBalanceGeneralNec(String codigoCP, String fechaDesde, String fechaHasta, String bgCuenta,
			String bgDetalle, BigDecimal bgSaldo1, BigDecimal bgSaldo2, BigDecimal bgSaldo3, BigDecimal bgSaldo4,
			BigDecimal bgSaldo5, BigDecimal bgSaldo6) {
